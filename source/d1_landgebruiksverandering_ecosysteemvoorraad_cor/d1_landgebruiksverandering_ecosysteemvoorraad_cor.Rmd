...
ecos <- c("Stedelijk en bebouwd gebied", "Agro-ecosysteem" # nolint
          "Bos en terrestrische open natuur", "Zoetwater en estuarium", "Zee") # nolint
...
sankeyNetwork(Links = data$links, Nodes = data$nodes, Source = 'source',
              ...
              units = 'ha', colourScale = , fontSize = 12, nodeWidth = 25,
              nodePadding = 20)
```
