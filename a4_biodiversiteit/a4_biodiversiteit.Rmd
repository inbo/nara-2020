...
```{r biodiversiteit, fig.width = 7, fig.height = 5, fig.cap = "Figuur 1. Het aantal indicatoren in dit Natuurrapport gerangschikt volgens de vier organisatieniveaus en de vier invalshoeken voor het beschrijven van de biodiversiteit. Deze figuur verwijst naar figuur 6 uit het Natuurrapport 2020."}
