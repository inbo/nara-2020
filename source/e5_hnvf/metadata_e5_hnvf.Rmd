...
intensiteit_perceel %>%
  ...
  kable(
    ...
    col.names = linebreak(
      c(
        "Teeltcombinaties",
        "Percentage en type KLE/beheerovereenkomst", # nolint: nonportable_path_linter, line_length_linter.
...
nitraat %>%
  ...
  kable(
    ...
    col.names = linebreak(
      c(
        "Teeltgroep",
        "Mediaan nitraatresidu (kg nitraat-N/ha, klasse)", # nolint: nonportable_path_linter, line_length_linter.
        "Intensiteitsscore"
      )
    ),
    align = c("l")
...
seqscore %>%
  ...
  kable(
    ...
    escape = FALSE,
    col.names = linebreak(c(
      "Teeltgroep", "Gemiddelde seq/ha", # nolint: nonportable_path_linter, line_length_linter.
