...
library(tidyverse)
library(INBOtheme)
library(gridExtra) # Om meerdere grafieken naast mekaar te zetten
library(here)
library(rstan)
library(brms)
library(sf)
...
# save(brm_Bostypes, file = "Bostypes.Rdata")  # nolint

load(file = "bostypes.rdata") # nolint
