...
```
```{r staafdiagram, fig.width = 10, fig.height = 5, fig.cap = "Figuur 1: Procentuele klassenverdeling van PCB-concentraties in spierweefsel van paling (op vetbasis) in de periode 2015-2018 Bron: ([@teunen_veldstudies_2020-1]). Deze figuur komt overeen met figuur 106 in het Natuurrapport 2020. "}
...
In de periode 2015-2018 scoort 68 procent van de 41 meetplaatsen slecht tot zeer slecht en 51 procent van de metingen overschrijdt nog altijd de humane consumptienorm [@teunen_veldstudies_2020-1].
