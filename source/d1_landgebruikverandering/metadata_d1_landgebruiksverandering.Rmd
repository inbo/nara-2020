...
gegevens_clslgv %>%
  ...
  kable(
    caption =
"Tabel 3: Klassen van aangepaste bodembedekkingskaart en landgebruikskaart en
omzetting landgebruikskaart naar ecosysteemvoorraad.",
    col.names = c(
      "Aangepaste bodembedekkingskaart", "Aangepaste landgebruikskaart",
...
- **Broncode indicator**: [d1_landgebruiksverandering.Rmd](../d1_landgebruiksverandering/d1_landgebruiksverandering.Rmd)
- **Basisdata**: [datastglgv.tsv](../d1_landgebruiksverandering/datastglgv.tsv), [datastalgv.tsv](../d1_landgebruiksverandering/datastalgv.tsv), [dataflglgv.tsv](dataflglgv.tsv), [dataflglgvcode.tsv](../d1_landgebruiksverandering/dataflglgvcode.tsv), [dataflalgv.tsv](dataflalgv.tsv), [dataclslgv.tsv](../d1_landgebruiksverandering/datacslslgv.tsv)
- **Metadata basisdata**: [datastglgv.yml]../d1_landgebruiksverandering/(../d1_landgebruiksverandering/datastglgv.yml), [datastalgv.yml](../d1_landgebruiksverandering/datastalgv.yml), [dataflglgv.yml](../d1_landgebruiksverandering/dataflglgv.yml), [dataflgcodelgv.yml](dataflgcodelgv.yml), [dataflalgv.yml](../d1_landgebruiksverandering/dataflalgv.yml), [dataclslgv.yml](../d1_landgebruiksverandering/datacslslgv.yml)
