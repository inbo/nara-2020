...
read_vc("tabel") %>%
  rename("Toelichting landgebruik Newbold et al., 2015" = "Toelichting.Newbold.et.al...2015", "Toelichting intensiteit Newbold et al., 2015" = "Toelichting.Newbold.et.al...2015.1", "Land use BII" = "Land.use.BII", "Land use intensity BII" = "Land.use.intensity.BII") %>%
  kbl(caption = "Tabel 1. BII-score per landgebruiksklasse voor de abundantie van soorten. De score wordt aan een landgebruiksklasse toegekend op basis van landgebruik en intensiteit volgens Newbold et al., 2015.") %>%
...
**Broncode indicator**:
[c1_impact_op_biodiversiteit_bii.Rmd](c1_impact_op_biodiversiteit_bii.Rmd)
- **Basisdata**: [bii_lgnara2020.tsv](bii_lgnara2020.tsv)
- **Metadata basisdata**: [bii_lgnara2020.yml](bii_lgnara2020.yml)
