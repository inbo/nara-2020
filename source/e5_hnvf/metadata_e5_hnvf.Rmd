---
title: "Metadata High Nature Value farming"
...
intensiteit_omgeving %>%
  mutate_all(linebreak) %>%
  kable(
    caption = "Tabel 8. Voorbeelden van een niet-intensieve
        omgeving",
    booktabs = TRUE,
...
##### C1. Vegetatie en agrarisch beheer
...
Dit proces verloopt niet lineair maar is vaak het hoogst direct na een verandering in landgebruik of landbeheer [@dhose_mogelijkheden_2017]. 
...
##### D8. Geaggregeerde landgebruiksscore
...
Tabel 17 laat toe om indicatoren te selecteren per intensiteitsklasse.
...
intensiteitgegevens %>%
  datatable(
    caption = "Tabel 17. Intensiteitsscores landgebruiken",
    colnames = c(
    ...
    rownames = FALSE,
    extensions = c(
      "KeyTable", "Buttons", "Select",
      "SearchPanes", "Scroller"
    ),
    options = list(
      dom = "Bfrtip",
      filter = "none",
...
##### D9. Correctie beheerovereenkomsten en kleine landschapselementen
...
- **Basisdata**: [oppervlakte2hnvf.tsv](../e5_hnvf/oppervlakte2hnf.tsv), [intensiteit.tsv](../e5_hnvf/intensiteit.tsv), [subindicatoren.tsv](../e5_hnvf/subindicatoren.tsv), [kaartlagen.tsv](../e5_hnvf/kaartlagen.tsv), [keuze_methode.tsv](../e5_hnvf/keuze_methode.tsv) en [keuze_indicatoren.tsv](../e5_hnvf/keuze_indicatoren.tsv)
